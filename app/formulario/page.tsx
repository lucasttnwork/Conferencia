...
export default function FormularioPage() {
    return (
        <main className="min-h-screen bg-[#0A192F] py-12 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center relative overflow-hidden">
            {/* Ambient Background Effects - Blue Tones Only */}
            ...
            <div className="max-w-4xl mx-auto w-full relative z-10">
                <div className="mb-12 text-center">
                    ...
                    <p className="text-xl text-blue-400/80 font-light tracking-wide">
