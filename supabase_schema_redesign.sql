...
CREATE TABLE IF NOT EXISTS public.cards (
	...
	trello_id TEXT NOT NULL,
	board_id UUID NOT NULL REFERENCES public.boards(id) ON DELETE CASCADE,
	current_list_id UUID REFERENCES public.lists(id) ON DELETE SET NULL,
	name TEXT,
	description TEXT,
	url TEXT,
...
CREATE TABLE IF NOT EXISTS public.card_events (
	...
	board_name TEXT,
	list_from_id UUID REFERENCES public.lists(id) ON DELETE SET NULL,
	list_from_name TEXT,
	list_to_id UUID REFERENCES public.lists(id) ON DELETE SET NULL,
	list_to_name TEXT,
...
CREATE TABLE IF NOT EXISTS public.card_movements (
	...
	card_id UUID NOT NULL REFERENCES public.cards(id) ON DELETE CASCADE,
	board_id UUID NOT NULL REFERENCES public.boards(id) ON DELETE CASCADE,
	from_list_id UUID REFERENCES public.lists(id) ON DELETE SET NULL,
	to_list_id UUID REFERENCES public.lists(id) ON DELETE SET NULL,
	moved_by_member_id UUID REFERENCES public.members(id) ON DELETE SET NULL,
...
WITH list_stats AS (
	...
	FROM public.lists l
	LEFT JOIN public.cards c ON c.current_list_id = l.id
